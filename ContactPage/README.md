# Contact Page  - Solution

<img src="./screen/desktop.jpg" alt="Solucion preview" style="max-width: 100%; height: auto;">

Esta es una solución del proyecto **Contact Page** como parte de auto reto de codificación #SisePuede Miguel Ramos Alarcón. La mejor manera de escribir un buen código es programando todos los días🔥.
...
[Dev Challenges Minimal Blog card](https://devchallenges.io/editor/solution/25001)
...
- [Pagina web](https://miguelramosalarcon.github.io/personal_challenges/ContactPage/)
- [Codigo fuente]()

# Minimal Blog Card  - Solution

<img src="./screen/desktop.png" alt="Solucion preview" style="max-width: 100%; height: auto;">

Esta es una solución del proyecto **Minimal Blog Card** como parte de auto reto de codificación #SisePuede Miguel Ramos Alarcón. La mejor manera de escribir un buen código es programando todos los días🔥.
...
[Dev Challenges Minimal Blog card](https://devchallenges.io/editor/solution/22099)
...
- [Pagina web](https://miguelramosalarcon.github.io/personal_challenges/MinimalBlogCard/)
- [Codigo fuente]()
